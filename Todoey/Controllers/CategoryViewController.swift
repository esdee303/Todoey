...
class CategoryViewController: SwipeTableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // using chameleon framework to color cell --> if no color is set, use the default color
        cell.backgroundColor = UIColor(hexString: categories?[indexPath.row].colour ?? "00FA9A")
